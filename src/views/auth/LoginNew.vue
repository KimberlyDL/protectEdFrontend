            ...
            <div class="bg-platinum-50 dark:bg-abyss-700">
                ...
                <div class="relative my-6">
                    ...
                    <div class="relative flex justify-center">
                        <span
                            class="bg-white dark:bg-abyss-700 px-3 text-xs text-platinum-500 dark:text-platinum-400 uppercase tracking-wider font-medium">
                            Or continue with
                        </span>
                    </div>
                </div>
...
const loginWithGoogle = async () => {
    ...
    try {
        // ADD /v1/ here to match your backend app.use logic
